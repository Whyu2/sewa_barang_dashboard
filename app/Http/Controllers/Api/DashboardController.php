...
class DashboardController extends BaseController
{
    ...
    public function stats(Request $request) {
        return $this->success($this->service->getStats($request->from, $request->to, $request->region_id, $this->resolveCreatedBy($request)));
    }
    ...
    public function tables(Request $request) {
        return $this->success($this->service->getTables($request->from, $request->to, $request->region_id, $this->resolveCreatedBy($request)));
    }
